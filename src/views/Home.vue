<template>
    <div style="background-color: rgb(139, 183, 168);height:50px;width:100%;display: flex;flex-direction: row;">
        <el-button type="text" @click="toggle" style="margin-top: 17px;margin-left:20px;">
            <el-icon :size="25">
